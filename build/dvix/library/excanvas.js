...
KISSY.add('dvix/library/excanvas', function (S) {
    ...
    if (!document.createElement('canvas').getContext) {
        (function () {
            ...
            function CanvasRenderingContext2D_(canvasElement) {
                ...
                this.fillStyle = '#000';    //添加对shadow的支持 @释剑
                //添加对shadow的支持 @释剑
                this.shadowBlur = 0;
            ...
            contextPrototype.stroke = function (aFill) {
                ...
                if (this.shadowOffsetY != 0 && this.shadowOffsetX != 0 && this.shadowColor != 'rgba(0,0,0,0)') {
                    lineStr.push('<g_vml_:shadow on="True" offset="' + this.shadowOffsetX / 2 + 'px,' + this.shadowOffsetY / 2 + 'px" />');
                }
