KISSY.add('dvix/library/excanvas', function () {
    return document.createElement('canvas').getContext ? G_vmlCanvasManager = !1 : !function () {
        ...
        function n(a) {
            var b, c, d, e, f, g;
            if (e = parseFloat(a[0]) / 360 % 360, 0 > e && e++, f = m(l(a[1]), 0, 1), g = m(l(a[2]), 0, 1), 0 == f)
                b = c = d = g;
            else {
                var h = 0.5 > g ? g * (1 + f) : g + f - g * f, i = 2 * g - h;
        ...
        function p(a) {
            if (a in U)
                return U[a];
            var b, c = 1;
            if (a = String(a), '#' == a.charAt(0))
                b = a;
            else if (/^rgb/.test(a)) {
                for (var d, e = k(a), b = '#', f = 0; 3 > f; f++)
                    d = -1 != e[f].indexOf('%') ? Math.floor(255 * l(e[f])) : +e[f], b += Q[m(d, 0, 255)];
                c = +e[3];
            } else if (/^hsl/.test(a)) {
                var e = k(a);
                b = n(e), c = e[3];
        ...
        function r(a, b) {
            ...
            return c.size = 'number' == typeof a.size ? a.size : -1 != a.size.indexOf('px') ? f : -1 != a.size.indexOf('em') ? e * f : -1 != a.size.indexOf('%') ? e / 100 * f : -1 != a.size.indexOf('pt') ? f / 0.75 : e, c.size *= 0.981, c;
        }
        function s(a) {
        ...
        function u(a) {
            this.m_ = h(), this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = '#000', this.fillStyle = '#000', this.shadowBlur = 0, this.shadowColor = 'rgba(0,0,0,0)', this.shadowOffsetX = 0, this.shadowOffsetY = 0, this.lineWidth = 1, this.lineJoin = 'miter', this.lineCap = 'butt', this.miterLimit = 1 * M, this.globalAlpha = 1, this.font = '10px sans-serif', this.textAlign = 'left', this.textBaseline = 'alphabetic', this.canvas = a;
        ...
        function x(a, b, c, d) {
            ...
            if (e instanceof B) {
                ...
                if ('gradient' == e.type_) {
                    ...
                    j = 180 * Math.atan2(u, v) / Math.PI, 0 > j && (j += 360), 0.000001 > j && (j = 0);
                } else {
        ...
        Y.clearRect = function () {
            ...
            if (a.runtimeStyle.width = j, a.runtimeStyle.height = k, 3 == arguments.length)
                b = arguments[1], c = arguments[2], f = g = 0, h = d = l, i = e = m;
            else if (5 == arguments.length)
                b = arguments[1], c = arguments[2], d = arguments[3], e = arguments[4], f = g = 0, h = l, i = m;
            else {
            ...
            if (o.push(' <g_vml_:group', ' coordsize="', M * p, ',', M * q, '"', ' coordorigin="0,0"', ' style="width:', p, 'px;height:', q, 'px;position:absolute;'), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                ...
                o.push('top:', H(n.y / M), 'px;left:', H(n.x / M), 'px;');
            ...
            b.push(' ">'), a ? x(this, b, e, f) : w(this, b), 0 != this.shadowOffsetY && 0 != this.shadowOffsetX && 'rgba(0,0,0,0)' != this.shadowColor && b.push('<g_vml_:shadow on="True" offset="' + this.shadowOffsetX / 2 + 'px,' + this.shadowOffsetY / 2 + 'px" />'), b.push('</g_vml_:shape>'), this.element_.insertAdjacentHTML('beforeEnd', b.join(''));
        }, Y.fill = function () {
            this.stroke(!0);
            ...
            var g = this.m_, h = 1000, i = 0, j = h, k = {
                    x: 0,
                    y: 0
