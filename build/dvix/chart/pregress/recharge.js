...
KISSY.add('dvix/chart/pregress/recharge', function (S, Chart, Sector, Circle, Line, Rect, Tween) {
    ...
    return Chart.extend({
        ...
        holdHand: function (e) {
            ...
            new Tween.Tween({ ringWidth: this.config.ringWidth }).to({ ringWidth: this.config.ringWidth * 3 / 4 }, 300).onUpdate(function () {
            ...
            new Tween.Tween({ num: 0 }).to({ num: num }, 300).onUpdate(function () {
        ...
        releaseHand: function (e) {
            ...
            new Tween.Tween({
                ringWidth: this.r - btn.context.r,
                rotation: 0,
                globalAlpha: 0
            }).to({
