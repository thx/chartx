    ...
    */
    ...
    return Chart.extend({
        init: function () {
            ...
            this.stageCore = new Canvax.Display.Sprite({ id: 'graph' });
        ...
        draw: function () {
            ...
            this._getR();    //初始化模块
            //初始化模块
            this._initModule(this, this.dataFrame);    //开始绘图
            //开始绘图
...
;
            ...
            this._graphs.setPosition(backX, backY);    //绘制xAxis标注
            //绘制xAxis标注
            this._xAxis.draw({ r: r });
