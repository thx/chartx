KISSY.add('dvix/chart/radar/xaxis', function (S, Canvax, Isogon) {
    ...
    xAxis.prototype = {
        init: function (opt, data) {
            this.sprite = new Canvax.Display.Sprite({ id: 'xAxis' });
        ...
        _trimXAxis: function () {
            ...
            var me = this;    //因为pointList的最后一个元素 是 和 第一个数据重复的。
        ...
        _widget: function () {
            ...
            _.each(this.data, function (item) {
                ...
                me.sprite.addChild(new Canvax.Display.Text(item.content, { context: c }));
            });
        },
        /**
        ...
        _getTextAlignForPoint: function (r) {
            ...
            var textBaseline = 'bottom';    /* 默认的就不用判断了
            if(r==-Math.PI/2){
                return {
                    textAlign    : "center",
                    textBaseline : "bottom"
