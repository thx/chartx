KISSY.add('dvix/components/tips/Tip', function (S, Dvix, Circle, Rect, Tools) {
    ...
    Tip.prototype = {
        ...
        _widget: function () {
            var self = this;    // var sign = new Canvax.Shapes.Circle({
                                //     context:{
                                //         r         : 5,
                                //         fillStyle : '#ff0000'
                                //     }
            ...
            self.txtSp = new Canvax.Display.Sprite(), self.widgetSp.addChild(self.txtSp)    // self.sprite.addChild(sign)
;
