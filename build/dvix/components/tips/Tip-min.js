KISSY.add('dvix/components/tips/Tip', function (a, b, c, d, e) {
    ...
    return g.prototype = {
        ...
        _widget: function () {
            var a = this;
            a.widgetSp = new f.Display.Sprite(), a.sprite.addChild(a.widgetSp), a.backSp = new f.Display.Sprite(), a.widgetSp.addChild(a.backSp), a.txtSp = new f.Display.Sprite(), a.widgetSp.addChild(a.txtSp);
            var b = a._lay, g = a.data.length, h = 0;
            a.data[0] && (h = a.data[0].length);
            for (var i = 0, j = a.data.length; j > i; i++) {
                var k = 0, l = new f.Display.Sprite();
                a.txtSp.addChild(l);
                for (var m = 0, n = a.data[i].length; n > m; m++) {
                    var o = a.data[i][m], p = o.bold || 'normal', q = o.fillStyle || '#000000', r = o.fontSize || 13, s = e.numAddSymbol(o.content) || '', t = new f.Display.Text(s, {
                            context: {
                                fillStyle: q,
                                fontSize: r,
                                fontWeight: p
                    ...
                    if (l.addChild(t), k = Math.max(k, t.getTextHeight()), b.y_maxW[m] || (b.y_maxW[m] = 0, b.y_maxAllW[m] = 0), b.y_maxW[m] < t.getTextWidth() && (b.y_maxW[m] = t.getTextWidth(), b.y_maxAllW[m] = b.y_maxW[m]), o.sign && o.sign.enabled) {
                        var u = o.sign.radius || 4, v = o.sign.disX || 4;
                        b.y_maxAllW[m] = Number(b.y_maxW[m]) + 2 * Number(u) + Number(v);
                    }
                }
                b.x_maxH.push(k);
            }
            for (var w = 0, x = a.data.length; x > w; w++)
                for (var l = a.txtSp.getChildAt(w), y = 0, z = a.data[w].length; z > y; y++) {
                    var o = a.data[w][y], t = l.getChildAt(y), A = e.getArrMergerNumber(b.y_maxAllW, 0, y - 1) + y * a.text.disY, B = w > 0 ? e.getArrMergerNumber(b.x_maxH, 0, w - 1) + w * a.text.disX : 0;
                    l.context.y = B, B = 0;
                    var C = o.y_align || 2, D = o.x_align || 2;
                    if (2 == C ? A += (b.y_maxAllW[y] - t.getTextWidth()) / 2 : 3 == C && (A = A + b.y_maxAllW[y] - t.getTextWidth()), 2 == D ? B += (b.x_maxH[w] - t.getTextHeight()) / 2 : 3 == D && (B = B + b.x_maxH[w] - t.getTextHeight()), o.sign) {
            ...
            a.back.enabled || (a.back.disX = 0, a.back.disY = 0), a.txtSp.context.x = a.back.disX, a.txtSp.context.y = a.back.disY, F = e.getArrMergerNumber(b.y_maxAllW) + 2 * a.back.disX + H, G = e.getArrMergerNumber(b.x_maxH) + 2 * a.back.disY + I, a.w = F, a.h = G;
