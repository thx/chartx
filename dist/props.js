  ...
  */
  ...
  function (_Component) {
    ...
    function coorBase(opt, app) {
      ...
      _.extend(true, _assertThisInitialized(_assertThisInitialized(_this)), getDefaultProps(defaultProps$1));
  ...
  */
  ...
  function (_coorBase) {
    ...
    function _default(opt, app) {
      ...
      _.extend(true, _assertThisInitialized(_assertThisInitialized(_this)), getDefaultProps(defaultProps$2), _this.setDefaultOpt(opt, app));
  ...
  function (_coorBase) {
    ...
    function _default(opt, app) {
      ...
      _.extend(true, _assertThisInitialized(_assertThisInitialized(_this)), getDefaultProps(defaultProps$3), _this.setDefaultOpt(opt, app));
  ...
  function (_GraphsBase) {
    ...
    function Progress(opt, app) {
      ...
      _.extend(true, _assertThisInitialized(_assertThisInitialized(_this)), getDefaultProps(defaultProps$4), opt);
  ...
  function (_Component) {
    ...
    function dataZoom(opt, app) {
      ...
      _.extend(true, _assertThisInitialized(_assertThisInitialized(_this)), defaultProps$5, opt);
