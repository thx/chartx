...
var Tips = function (_Component) {
    ...
    createClass$1(Tips, [{
        ...
        value: function _getContent(e) {
            ...
            if (this.content) {
                tipsContent = _$5.isFunction(this.content) ? this.content(this.eventInfo) : this.content;
            } else {
...
var DataFrame = function (data) {
    ...
    //检测第一个数据是否为一个array, 否就是传入了一个json格式的数据
    if (data.length > 0 && !_$9.isArray(data[0])) {
    ...
    */
    ...
    function _getFieldData(field) {
        var data;
        _$9.each(dataFrame.data, function (d) {
            if (d.field == field) {
                data = d;
            }
        });
    ...
    createClass$1(Descartes, [{
        ...
        value: function _initMarkLine() {
            ...
            _$8.each(me.markLine, function (ML) {
                ...
                if (field && _$8.indexOf(me.dataFrame.fields, field) == -1) {
                    //如果配置的字段不存在，则不绘制
                    return;
                }
...
var xAxis = function (_Component) {
    ...
    function xAxis(opt, data, _coordinate) {
        ...
        _this.data = []; //{x:100, value:'1000',visible:true}
    ...
    createClass$1(xAxis, [{
        ...
        key: "_computerConfit",
        value: function _computerConfit(opt) {
            if (opt) {
                _$15.extend(true, this, opt);
            }
        ...
        value: function getPosX(opt) {
            var x = 0;
            var val = opt.val;
            var ind = "ind" in opt ? opt.ind : _$15.indexOf(this.dataSection, val); //如果没有ind 那么一定要有val
        ...
        value: function _getXAxisDisLine() {
            ...
            var disMax = 2 * disMin;
            var dis = disMin;
            dis = disMin + this.width % _$15.flatten(this.dataOrg).length;
    ...
    createClass$1(yAxis, [{
        ...
        value: function reset(opt, data) {
            ...
            if (opt) {
                ...
                _$17.extend(true, this._opt, opt);
            }
        ...
        key: "_oneDimensional",
        value: function _oneDimensional(d) {

            var arr = _$17.flatten(d); //_.flatten( data.org );
        ...
        key: "_twoDimensional",
        value: function _twoDimensional(d) {
            var arr = [];
            var min;
...
var Descartes_Component = function (_Component) {
    ...
    createClass$1(Descartes_Component, [{
            ...
            _$14.each(this._yAxis, function (_yAxis) {
                ...
                if (opt && opt.yAxis) {
                    ...
                    if (_yAxis.place == "left") {
                        ...
                        _opt = _$14.find(yAxis$$1, function (ya) {
                    ...
                    if (_opt && _opt.field) {
                        ...
                        newYaxisFields = newYaxisFields.concat(_$14.flatten([_opt.field]));
        ...
        value: function _initModules() {
            ...
            this.yAxisFields = _$14.flatten([yAxisLeft.field]);
            ...
            if (yAxis$$1.length > 1) {
                ...
                this.yAxisFields = this.yAxisFields.concat(_$14.flatten([yAxisRight.field]));
            }
        ...
        value: function removeField(field) {
            ...
            _$14.each(this._yAxis, function (_yAxis, i) {
                ...
                if (ind > -1) {
                    ...
                    if (_$14.indexOf(_yAxis.enabledFields, field) == -1) {
                        _yAxis.enabledFields.push(field);
                    }
                    _fs = _$14.difference(_fs, _yAxis.enabledFields);
        ...
        value: function addField(field, targetYAxis) {
            ...
            var _fs = [];
            _$14.each(this._yAxis, function (_y, i) {
                var fs = _y.field;
                if (!_$14.isArray(fs)) {
                    fs = [fs];
                }
            ...
            var ind = _$14.indexOf(_yAxis.enabledFields, field);
            if (ind == -1) {
                return;
            } else {
                //需要update
        ...
        value: function getFieldsOfDisplay(maps) {
            ...
            _$14.each(this.fieldsDisplayMap, function (bamboo, b) {
...
var Graphs = function (_Canvax$Event$EventDi) {
    ...
    createClass$1(Graphs, [{
        ...
        value: function _setyAxisFieldsMap(opt) {
            ...
            _$19.each(yAxisFields, function (field, i) {
        ...
        value: function _getColor(c, groups, vLen, i, h, v, value, field) {
            ...
            if (_$19.isArray(c)) {
                style = _$19.flatten(c)[this._yAxisFieldsMap[field].index];
            }
        ...
        value: function _trimGraphs() {
            ...
            var hLen = 0;
            _$19.each(_yAxis, function (_yaxis) {
            ...
            _$19.each(_yAxis, function (_yaxis, yind) {
                //dataOrg和field是一一对应的
                _$19.each(_yaxis.dataOrg, function (hData, b) {
        ...
        value: function _getNodeInfo(iGroup, iNode, iLay) {
            ...
            _$19.each(me.data, function (h_group, i) {
                var node;
                var vLen = h_group.length;
                if (vLen == 0) return;
                var hLen = h_group[0].length;
...
var Bar = function (_Chart) {
    ...
    createClass$1(Bar, [{
        ...
        key: "drawMarkLine",
        value: function drawMarkLine(ML, yVal, _yAxis, field) {
...
var LineGraphsGroup = function (_Canvax$Event$EventDi) {
    ...
    createClass$1(LineGraphsGroup, [{
        ...
        value: function getNodeInfoAt($index) {
            var o = _$22.clone(this.data[$index]);
        ...
        key: "update",
        value: function update(opt, date) {
            if (!this._bline) {
                return;
            }
            _$22.extend(true, this, opt);
            ...
            function __trimGraphs(_yAxis) {
                ...
                _$21.each(_fields, function (field, i) {
                    ...
                    for (var b = 0, bl = _lineData.length; b < bl; b++) {
                        ...
                        var y = _$21.isNumber(_lineData[b]) ? _yAxis.getYposFromVal(_lineData[b]) : _lineData[b];
...
var Line$6 = function (_Chart) {
    ...
    createClass$1(Line, [{
        ...
        value: function _initModule(opt) {
            ...
            this._tips = new LineTips(this.tips, this.canvax.domView, this.dataFrame);
        ...
        key: "bindEvent",
        value: function bindEvent(_setXaxisYaxisToTipsInfo) {
        ...
        value: function _widget() {
            ...
            _$28.each(this.groupsData, function (group, iGroup) {
                ...
                _$28.each(group.list, function (nodeData, iNode) {
                    ...
                    var Shape = nodeData.shapeType == "circle" ? Circle$6 : Rect$7;
