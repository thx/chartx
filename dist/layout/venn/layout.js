...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "fmin", "./circleintersection"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("fmin"), require("./circleintersection"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.fmin, global.circleintersection);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _fmin, _circleintersection) {
  "use strict";
  ...
  function venn(areas, parameters) {
    ...
    var solution = (0, _fmin.nelderMead)(function (values) {
  ...
  function distanceFromIntersectArea(r1, r2, overlap) {
    ...
    return (0, _fmin.bisect)(function (distance) {
      return (0, _circleintersection.circleOverlap)(r1, r2, distance) - overlap;
    }, 0, r1 + r2);
  }
  ...
  function getDistanceMatrices(areas, sets, setids) {
    ...
    var distances = (0, _fmin.zerosM)(sets.length, sets.length),
        constraints = (0, _fmin.zerosM)(sets.length, sets.length); // compute required distances between all the sets such that
    // the areas match
  ...
  function constrainedMDSLayout(areas, params) {
    ...
    var norm = (0, _fmin.norm2)(distances.map(_fmin.norm2)) / distances.length;
    ...
    for (i = 0; i < restarts; ++i) {
      var initial = (0, _fmin.zeros)(distances.length * 2).map(Math.random);
      current = (0, _fmin.conjugateGradient)(obj, initial, params);
    ...
    if (params.history) {
      for (i = 0; i < params.history.length; ++i) {
        (0, _fmin.scale)(params.history[i].x, norm);
      }
    }
    ...
    for (i = 1; i < mostOverlapped.length; ++i) {
      ...
      for (var j = 0; j < overlap.length; ++j) {
        ...
        for (var k = j + 1; k < overlap.length; ++k) {
          ...
          var extraPoints = (0, _circleintersection.circleCircleIntersection)({
            x: p1.x,
            y: p1.y,
            radius: d1
          }, {
  ...
  function lossFunction(sets, overlaps) {
    ...
    for (var i = 0; i < overlaps.length; ++i) {
      ...
      if (area.sets.length == 1) {
        ...
        overlap = (0, _circleintersection.circleOverlap)(left.radius, right.radius, (0, _circleintersection.distance)(left, right));
      } else {
        overlap = (0, _circleintersection.intersectionArea)(getCircles(area.sets));
      }
  ...
  function orientateCircles(circles, orientation, orientationOrder) {
    ...
    if (circles.length == 2) {
      ...
      var dist = (0, _circleintersection.distance)(circles[0], circles[1]);
  ...
  function disjointCluster(circles) {
    ...
    for (var i = 0; i < circles.length; ++i) {
      for (var j = i + 1; j < circles.length; ++j) {
        ...
        if ((0, _circleintersection.distance)(circles[i], circles[j]) + 1e-10 < maxDistance) {
