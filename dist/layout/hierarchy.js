...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./utils/rebind", "./utils/arrays"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./utils/rebind"), require("./utils/arrays"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.rebind, global.arrays);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _rebind, _arrays) {
  "use strict";
  ...
  Hierarchy.layout_hierarchyRebind = function (object, hierarchy) {
    (0, _rebind2["default"])(object, hierarchy, "sort", "children", "value");
    object.nodes = object;
  ...
  function layout_hierarchyLinks(nodes) {
    return _arrays2["default"].merge(nodes.map(function (parent) {
