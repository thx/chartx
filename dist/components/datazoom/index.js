...
(function (global, factory) {
  ...
  var dataZoom = function (_Component) {
    ...
    function dataZoom(opt, app) {
      ...
      _this.dataZoomBg = new _canvax2["default"].Display.Sprite({
        id: "dataZoomBg"
      });
      _this.dataZoomBtns = new _canvax2["default"].Display.Sprite({
        id: "dataZoomBtns"
      });
      ...
      _mmvis._.extend(true, _assertThisInitialized(_this), (0, _mmvis.getDefaultProps)(dataZoom.defaultProps()), opt);
    ...
    _createClass(dataZoom, [{
        ...
        _mmvis._.extend(true, this, {
          ...
          dragIng: function dragIng(range) {
            ...
            if (me.axisLayoutType == 'proportion') {
              trigger = new _trigger2["default"](me, {
                min: range.start,
                max: range.end
              });
      ...
      value: function widget() {
        ...
        if (!this.linesLeft) {
          this.linesLeft = new _canvax2["default"].Display.Sprite({
            id: "linesLeft"
          });
        ...
        if (!this.linesRight) {
          this.linesRight = new _canvax2["default"].Display.Sprite({
            id: "linesRight"
          });
        ...
        if (!this.linesCenter) {
          this.linesCenter = new _canvax2["default"].Display.Sprite({
            id: "linesCenter"
          });
