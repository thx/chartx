...
function (_GraphsBase) {
  ...
  function Progress(opt, app) {
    ...
    _mmvis._.extend(true, (0, _assertThisInitialized2["default"])(_this), (0, _mmvis.getDefaultProps)(Progress.defaultProps()), opt);
        ...
        _mmvis._.each(nodeDatas, function (nodeData, i) {
          ...
          if (me.label.enabled) {
            ...
            if (labelElement) {
              ...
              var labelElement = new _canvax["default"].Display.Text(nodeData.text, {
                id: labelId,
                context: labelCtx
              });
            ...
            if (labelSymbolElement) {
              ...
              var labelSymbolElement = new _canvax["default"].Display.Text(unitText, {
                id: labelSymbolId,
