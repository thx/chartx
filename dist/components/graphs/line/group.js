...
function (_event$Dispatcher) {
  ...
  function LineGraphsGroup(fieldMap, iGroup, opt, ctx, h, w, _graphs) {
    ...
    _mmvis._.extend(true, (0, _assertThisInitialized2["default"])(_this), (0, _mmvis.getDefaultProps)(LineGraphsGroup.defaultProps()), opt); //TODO group中得field不能直接用opt中得field， 必须重新设置， 
