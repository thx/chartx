...
(function (global, factory) {
  ...
  var PlanetGroup = function () {
    ...
    function PlanetGroup(opt, dataFrame, _graphs) {
      ...
      _mmvis._.extend(true, this, (0, _mmvis.getDefaultProps)(PlanetGroup.defaultProps()), opt); //circle.maxRadius 绝对不能大于最大 占位 pit.radius
    ...
    _createClass(PlanetGroup, [{
      ...
      value: function _trimGraphs() {
        ...
        for (var i = 0; i < dataLen; i++) {
          ...
          var planetLayoutData = {
            ...
            focused: false,
            selected: !!~_mmvis._.indexOf(this.selectInds, rowData.__index__)
          };
        ...
        if (me.sortField) {
          ...
          _mmvis._.each(planets, function (planet, i) {
            planet.iNode = i;
          });
        }
      ...
      value: function _setRings_radianRange(planets) {
        ...
        _mmvis._.each(_rings, function (ring, i) {
          ...
          _mmvis._.each(ring.arcs, function (arc) {
          ...
          ring.pits = _mmvis._.shuffle(ring.pits);
        ...
        _mmvis._.each(_rings, function (ring, i) {
          ...
          _mmvis._.each(ring.planets, function (planet, ii) {
            ...
            var pits = _mmvis._.filter(ring.pits, function (pit) {
      ...
      value: function draw() {
        ...
        _mmvis._.each(this._rings, function (ring, i) {
          var _ringCtx = {
            rotation: 0
          };
          ...
          var _ringSp = new _canvax2["default"].Display.Sprite({
            context: _ringCtx
          });

          _mmvis._.each(ring.planets, function (p, ii) {
            if (!p.pit) {
            ...
            _circle.on(_mmvis.event.types.get(), function (e) {
              e.eventInfo = {
                title: null,
                trigger: me.node,
                nodes: [this.nodeData]
            ...
            var _label = new _canvax2["default"].Display.Text(p.label, {
              context: _labelCtx
            });
            ...
            if (_mmvis._.isFunction(me.label.position)) {
            ...
            _label = new _canvax2["default"].Display.Text(p.label, {
              context: _labelCtx
            }); //互相用属性引用起来
      ...
      value: function _getRProp(r, ringInd, iNode, nodeData) {
        ...
        if (_mmvis._.isString(r) && _mmvis._.indexOf(me.dataFrame.fields, r) > -1) {
          if (this.__rValMax == undefined && this.__rValMax == undefined) {
            this.__rValMax = 0;
            this.__rValMin = 0;

            _mmvis._.each(me.planets, function (planet) {
      ...
      value: function getPlanetAt(target) {
        ...
        if (_mmvis._.isNumber(target)) {
          _mmvis._.each(this.planets, function (_planet) {
      ...
      value: function getSelectedNodes() {
        return _mmvis._.filter(this.planets, function (planet) {
