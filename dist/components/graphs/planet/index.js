...
function (_GraphsBase) {
  ...
  function PlanetGraphs(opt, app) {
    ...
    _mmvis._.extend(true, (0, _assertThisInitialized2["default"])(_this), (0, _mmvis.getDefaultProps)(PlanetGraphs.defaultProps()), opt);
  ...
  (0, _createClass2["default"])(PlanetGraphs, [{
    ...
    value: function _drawGroups() {
      ...
      _mmvis._.each(this.groupDataFrames, function (df, i) {
        ...
        var _g = new _group["default"](_mmvis._.extend(true, {
          iGroup: i,
