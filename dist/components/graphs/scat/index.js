...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "canvax", "../index", "mmvis", "../../../utils/hull/index"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("canvax"), require("../index"), require("mmvis"), require("../../../utils/hull/index"));
  } else {
    var mod = {
      exports: {}
    };
  ...
  var Polygon = _canvax2["default"].Shapes.Polygon; //TODO iGroup 的实现有问题
  ...
  var ScatGraphs = function (_GraphsBase) {
    ...
    function ScatGraphs(opt, app) {
      ...
      _mmvis._.extend(true, _assertThisInitialized(_this), (0, _mmvis.getDefaultProps)(ScatGraphs.defaultProps()), opt);
    ...
    _createClass(ScatGraphs, [{
      key: "init",
      value: function init() {
        this._shapesp = new _canvax2["default"].Display.Sprite({
          id: "scat_shapesp"
        });
        this._textsp = new _canvax2["default"].Display.Sprite({
          id: "textsp"
        });
        this._linesp = new _canvax2["default"].Display.Sprite({
          id: "textsp"
        });
        this._areasp = new _canvax2["default"].Display.Sprite({
          id: "areasp"
        });
      ...
      value: function _widget() {
        ...
        _mmvis._.each(me.data, function (nodeData, iNode) {
          ...
          if (nodeData.label && me.label.enabled) {
            ...
            if (!_label) {
              _label = new _canvax2["default"].Display.Text(nodeData.label, {
                id: "scat_text_" + iNode,
                context: {}
              });
        ...
        if (me.area.enabled) {
          ...
          var _loop = function _loop() {
            ...
            areaPoints = (0, _index4["default"])(_groupPoints, me.area.concavity);
