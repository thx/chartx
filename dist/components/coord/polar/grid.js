...
function (_event$Dispatcher) {
  ...
  (0, _createClass2["default"])(polarGrid, null, [{
    key: "defaultProps",
  ...
  function polarGrid(opt, app) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(polarGrid).call(this, opt, app));
    _this.width = 0;
    _this.height = 0;
    ...
    _mmvis._.extend(true, (0, _assertThisInitialized2["default"])(_this), (0, _mmvis.getDefaultProps)(polarGrid.defaultProps()), opt);
