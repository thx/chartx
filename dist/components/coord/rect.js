...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./index", "canvax", "./xaxis", "./yaxis", "./grid", "mmvis"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./index"), require("canvax"), require("./xaxis"), require("./yaxis"), require("./grid"), require("mmvis"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.index, global.canvax, global.xaxis, global.yaxis, global.grid, global.mmvis);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _index, _canvax, _xaxis, _yaxis, _grid, _mmvis) {
  "use strict";
  ...
  var Rect = function (_coordBase) {
    ...
    function Rect(opt, app) {
      ...
      _mmvis._.extend(true, _assertThisInitialized(_this), (0, _mmvis.getDefaultProps)(Rect.defaultProps()), _this.setDefaultOpt(opt, app));
    ...
    _createClass(Rect, [{
      ...
      value: function _initModules() {
        ...
        this._xAxis = new _xaxis2["default"](this.xAxis, _xAxisDataFrame, this);
        ...
        if (yAxisLeft) {
          ...
          this._yAxisLeft = new _yaxis2["default"](yAxisLeft, yAxisLeftDataFrame, this);
        ...
        if (yAxisRight) {
          ...
          this._yAxisRight = new _yaxis2["default"](yAxisRight, yAxisRightDataFrame, this);
      ...
      value: function _initInduce() {
        var me = this;
        me.induce = new _canvax2["default"].Shapes.Rect({
          id: "induce",
          context: {
            x: me.origin.x,
