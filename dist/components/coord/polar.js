...
var _grid = _interopRequireDefault(require("./polar/grid"));
...
/*#__PURE__*/
function (_coorBase) {
  (0, _inherits2["default"])(Polar, _coorBase);
  ...
  function Polar(opt, app) {
    ...
    _mmvis._.extend(true, (0, _assertThisInitialized2["default"])(_this), (0, _mmvis.getDefaultProps)(Polar.defaultProps()), _this.setDefaultOpt(opt, app));
