var Chartx = (function () {
  ...
  */
  ...
  var global$1 = {
    create: function create(el, _data, _opt) {
      ...
      var componentModules = me.getComponentModules(dimension); //如果用户没有配置coord，说明这个图表是一个默认目标系的图表，比如标签云

      var Chart = me.getComponentModule('chart', dimension); //try {
  ...
  */
  ...
  global$1.registerComponent(barGuide$1, 'lineSchedu'); //皮肤设定begin ---------------
  //如果数据库中有项目皮肤
