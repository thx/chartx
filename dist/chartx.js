var Chartx = (function () {
  ...
  */
  ...
  function (_event$Dispatcher) {
    ...
    _createClass(Pie, [{
      ...
      value: function grow(callback) {
        ...
        var _tween = AnimationFrame$4.registTween({
          from: {
            process: 0
          },
          to: {
  ...
  global$1.registerComponent(Progress, 'graphs', 'progress'); //global.registerComponent( Relation, 'graphs', 'relation' );
  ...
  global$1.registerComponent(markCloumn, 'markcloumn'); //皮肤设定begin ---------------
  //如果数据库中有项目皮肤
  ...
  var _loop = function _loop() {
    ...
    var _loop2 = function _loop2() {
      ...
      moduleProps = module$1.defaultProps ? module$1.defaultProps() : {}; //处理props上面所有的 _props 依赖 begin
