var Chartx = (function () {
  ...
  */
  ...
  function isNotValibPoint( point ){
      var res = !point || 
      (_$2.isArray(point) && point.length >= 2 && (!_$2.isNumber(point[0]) || !_$2.isNumber(point[1])) ) || 
      ( "x" in point && !_$2.isNumber(point.x) ) ||
      ( "y" in point && !_$2.isNumber(point.y) );
  ...
  */
  ...
  var _class$1 = function (_coorBase) {
      inherits(_class, _coorBase);
  ...
  */
  ...
  global$1.registerComponent(_class$1, 'coord', 'polar');
