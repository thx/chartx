...
//设置
function __setXchartPropertyFactory(){
                ...
                if (valueType === "object" && typeof val.get === "function" && _.keys(val).length <= 2) {
                    ...
                    accessor = function(neo) { 
                        ...
                        if (arguments.length) {
                            ...
                            //走的getter
                            neo = accessor.value = model[name] = getter.call(pmodel , name);
                            if (value !== neo) {
                                oldArgs = void 0;
