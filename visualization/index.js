KISSY.add("visualization/index" , function( S ){
   ...
   var visualizationVersion  = "1.0.0";
   var visualizationUrl     = "http://g.tbcdn.cn/thx/charts";
   ...
   if( Site.daily ){
       visualizationUrl = "http://g.assets.daily.taobao.net/thx/canvax/1.0.0/";
   } 
   ...
   function useConstructor( chart , callback ){
       S.use("visualization/chart/"+chart.name.toLowerCase()+"/" , function(S , Chart ){
