...
daily环境为：http:// <code>g-assets.daily.taobao.net/thx/charts/1.9.52/chartx/index[-min].js</code>

cdn环境为 ： http://  <code>g.tbcdn.cn/thx/charts/1.9.51/chartx/index[-min].js</code>
