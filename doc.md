...
daily环境为：http:// <code>g-assets.daily.taobao.net/thx/charts/1.9.35/chartx/index[-min].js</code>

cdn环境为 ： http://  <code>g.tbcdn.cn/thx/charts/1.9.34/chartx/index[-min].js</code>
